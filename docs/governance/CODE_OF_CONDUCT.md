...
Instancias de comportamiento abusivo, acosador o inaceptable pueden ser reportadas a los administradores de la comunidad responsables del cumplimiento a través de:
...
MIESC (Marco Integrado de Evaluación de Seguridad en Smart Contracts) es un proyecto de investigación académica enfocado en ciberseguridad y defensa. Como comunidad técnica:

* Valoramos el rigor científico y el debate técnico constructivo
* Respetamos diferentes enfoques metodológicos y herramientas
* Fomentamos la colaboración entre academia e industria
* Promovemos la seguridad como un bien público digital

Este código de conducta refuerza nuestro compromiso con los **Objetivos de Desarrollo Sostenible (ODS) 16** de Naciones Unidas: Paz, Justicia e Instituciones Sólidas.
