...
| A.6 | Flujo de trabajo del desarrollador con MIESC | Diagrama completo mostrando 4 superficies (CLI, dashboard HTML, REST API, MCP), 7 capas de análisis, normalización y métricas de rendimiento | 328 |
