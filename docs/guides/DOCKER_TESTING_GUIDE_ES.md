# Probar Imágenes Docker de MIESC v6.0.0
...
Ambos comandos deberían mostrar **MIESC versión 6.0.0**.
...
| Tag | Contenido |
|-----|-----------|
| `miesc:latest` / `miesc:6.0.0` | Estándar: Slither, Aderyn, Solhint, Foundry (~15 herramientas) |
| `miesc:full` / `miesc:6.0.0-full` | Completa: + Mythril, Manticore, Echidna, Halmos, PyTorch (~30 herramientas) |

> **Nota:** Ignora cualquier versión anterior (pre-6.0.0) que pueda aparecer en el registry. Siempre usa los tags listados arriba.
