# Probar Imágenes Docker de MIESC v5.4.0
...
Ambos comandos deberían mostrar **MIESC versión 5.1.1**.
...
| Tag | Contenido |
|-----|-----------|
| `miesc:latest` / `miesc:5.1.1` | Estándar: Slither, Aderyn, Solhint, Foundry (~15 herramientas) |
| `miesc:full` / `miesc:5.1.1-full` | Completa: + Mythril, Manticore, Echidna, Halmos, PyTorch (~30 herramientas) |

> **Nota:** Ignora cualquier versión anterior (pre-5.1.1) que pueda aparecer en el registry. Siempre usa los tags listados arriba.
