...
|---------|--------------|---------|
| [Slither](https://github.com/crytic/slither) | Static analysis engine | AGPL-3.0 |
| [Mythril](https://github.com/ConsenSys/mythril) | Symbolic execution | MIT |
| [Echidna](https://github.com/crytic/echidna) | Property-based fuzzing | AGPL-3.0 |
| [Foundry](https://github.com/foundry-rs/foundry) | Testing toolkit | MIT/Apache-2.0 |
| [Halmos](https://github.com/a16z/halmos) | Symbolic testing | AGPL-3.0 |
| [Aderyn](https://github.com/Cyfrin/aderyn) | Rust-based analyzer | MIT |
| [Ollama](https://github.com/jmorganca/ollama) | Local LLM runtime | MIT |
...
2. Check [open issues](https://github.com/fboiero/MIESC/issues)
3. Submit your first pull request
4. Join the community!

---

*This file is updated regularly. Last update: February 2026*
