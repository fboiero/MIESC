...
| [Paper 2](./paper/paper2-remediation.pdf) | Artefactos de remediación verificables | 123/143 correcciones aplicadas; 123/123 contratos parcheados compilan standalone; 88/123 eliminan el hallazgo original por re-escaneo; 121/123 pasan no-regresión acotada; 70/123 clean-HIGH bajo Slither externo | [Reproducibilidad](./paper/PAPER2_REPRODUCIBILITY.md), [matriz de afirmaciones](./benchmarks/results/paper2_claims_matrix.json), [auditoría del experimento](./benchmarks/results/paper2_experiment_audit.json) |
...
- El Paper 2 evalúa artefactos de remediación: 123/143 correcciones aplicadas, 123/123 contratos parcheados compilan standalone, 88/123 eliminan el hallazgo original por re-escaneo, 121/123 pasan no-regresión acotada y 70/123 quedan clean-HIGH bajo Slither externo
