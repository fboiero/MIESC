...
def add_table_slide(prs, title, headers, rows):
    ...
    table = slide.shapes.add_table(
        table_rows, cols, Inches(0.5), Inches(1.3), Inches(9), Inches(0.5 * table_rows)
    ).table
...
def add_metrics_slide(prs, title, metrics):
    ...
    for i, (metric_name, metric_value, color) in enumerate(metrics):
        ...
        box = slide.shapes.add_shape(
            MSO_SHAPE.ROUNDED_RECTANGLE, Inches(x), Inches(y), Inches(4), Inches(1)
        )
        box.fill.solid()
        ...
        name_box = slide.shapes.add_textbox(
            Inches(x + 0.1), Inches(y + 0.1), Inches(3.8), Inches(0.4)
        )
        ...
        val_box = slide.shapes.add_textbox(
            Inches(x + 0.1), Inches(y + 0.5), Inches(3.8), Inches(0.5)
        )
...
def add_code_slide(prs, title, code, language="python"):
    ...
    code_box = slide.shapes.add_shape(
        MSO_SHAPE.RECTANGLE, Inches(0.5), Inches(1.0), Inches(9), Inches(5.5)
    )
    code_box.fill.solid()
...
def generate_presentation():
    ...
    add_table_slide(
        prs,
        "La Amenaza es Real: $7.8+ MIL MILLONES perdidos",
    ...
    add_image_slide(
        prs,
        "Taxonomia de Amenazas a Smart Contracts",
    ...
    add_image_slide(
        prs,
        "Arquitectura Defense-in-Depth de 7 Capas",
    ...
    add_image_slide(
        prs,
        "Flujo de Normalizacion SWC/CWE/OWASP",
...
""",
    ...
    add_image_slide(
        prs,
        "Arquitectura de Integracion MCP",
    ...
    add_table_slide(
        prs,
        "RQ1: Integracion de Herramientas - 100% (25/25)",
    ...
    add_metrics_slide(
        prs,
        "RQ3: Reduccion de Duplicados - 66%",
        [
    ...
    add_image_slide(
        prs,
        "Timeline de Ejecucion Paralela",
...
""",
    ...
    add_title_slide(
        prs, "Trabajo Posterior a la Tesis", "Desarrollado entre Octubre y Diciembre 2025"
    )

    # ==================== SLIDE 38: Post-Thesis Overview ====================
    add_content_slide(
        prs,
        "Trabajo Post-Tesis (v4.1.0 - v4.2.0)",
        [
