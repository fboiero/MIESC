            ...
            "findings": [
                {
                    ...
                    "tool_count": 2, "tool": "miesc-intelligence",
                    "description": "Reentrancy in withdraw()",
                    "location": {"file": "C.sol", "line": 10, "function": "withdraw"},
                    "fix_code": "// Use nonReentrant",
                    "exploit_scenario": ["1. Deploy attacker", "2. Call withdraw", "3. Re-enter"],
                },
                {
                    "type": "solc-version", "severity": "Info", "confidence": 0.50,
                    "canonical_category": "other",
                    "confirming_tools": ["aderyn"],
                    "tool_count": 1, "tool": "miesc-intelligence",
...
class TestReportQuality:
    def test_key_takeaways_not_empty(self, audit_results, tmp_path):
        ...
        result = CliRunner().invoke(report, [
            audit_results, "-t", "premium", "-o", out, "-f", "markdown",
        ])
        ...
        if idx > 0:
            ...
            assert "No AI summary" not in after or "vulnerabilit" in after.lower(), (
