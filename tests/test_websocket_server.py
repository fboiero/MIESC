...
class TestEventType:
    ...
    def test_event_type_values(self):
        ...
        from miesc.mcp_core.websocket_server import EventType
...
class TestAuditSession:
    ...
    def test_session_creation(self):
        ...
        from miesc.mcp_core.websocket_server import AuditSession
...
class TestStreamEvent:
    ...
    def test_event_creation(self):
        ...
        from miesc.mcp_core.websocket_server import EventType, StreamEvent
...
class TestWebSocketServerAsync:
    ...
    def test_send_event(self):
        ...
        pytest.importorskip("websockets")
        from miesc.mcp_core.websocket_server import EventType, MIESCWebSocketServer, StreamEvent
    ...
    def test_send_sessions_list(self):
        ...
        pytest.importorskip("websockets")
        from miesc.mcp_core.websocket_server import AuditSession, MIESCWebSocketServer
