...
class TestContextBus:
    ...
    def test_context_bus_publish(self):
        ...
        from miesc.mcp_core.context_bus import ContextBus, MCPMessage
...
class TestContextBusSingleton:
    ...
    def test_get_context_bus(self):
        ...
        from miesc.mcp_core.context_bus import get_context_bus, reset_context_bus
    ...
    def test_reset_context_bus(self):
        ...
        from miesc.mcp_core.context_bus import MCPMessage, get_context_bus, reset_context_bus
...
def test_get_context_bus_singleton_creation():
    ...
    import miesc.mcp_core.context_bus as cb
