"""
MIESC False Positive Filter
Filtro ML para reducir falsos positivos basado en características de hallazgos.
"""
...
class FalsePositiveFilter:
    ...
    def predict_false_positive(
        ...
        if confirmations >= 2:
            ...
            reasons.append(f"Cross-validated ({confirmations} tools): -{0.2 * min(confirmations - 1, 3):.2f}")
    ...
    def filter_findings(
        ...
        for finding in findings:
            ...
            fp_prob, explanation = self.predict_false_positive(
                finding, context, confirmations
            )
