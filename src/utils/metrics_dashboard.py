...
class XauditDashboard:
    ...
    def _chart_test_results(self, output_dir: Path):
        ...
        ax2.pie(
            echidna_data,
            labels=echidna_labels,
            colors=echidna_colors,
            autopct="%1.1f%%",
            startangle=90,
        )
...
def main():
    ...
    parser.add_argument(
        "--output", default="analysis/dashboard", help="Output directory for dashboard"
    )
