...
Integra Oyente (symbolic execution) a MIESC para complementar Mythril/Manticore.
Detecta vulnerabilidades mediante análisis simbólico de smart contracts.

Herramienta: Oyente (https://github.com/enzymefinance/oyente)
...
class OyenteAdapter(ToolAdapter):
    """
    Adapter para Oyente - Symbolic Execution Tool.

    Oyente usa análisis simbólico para explorar múltiples caminos de ejecución
    y detectar vulnerabilidades como:
