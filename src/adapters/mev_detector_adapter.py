...
Integra detección de vulnerabilidades MEV (Maximal Extractable Value) a MIESC.
Detecta vectores de front-running, sandwich attacks, y manipulación de transacciones.

Herramienta: Custom (análisis basado en patrones conocidos de MEV)
