...
Integra análisis de optimización de gas a MIESC.
Detecta patrones que consumen gas innecesario en smart contracts.

Herramienta: Custom (análisis basado en patrones conocidos de Solidity)
