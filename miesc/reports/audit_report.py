...
try:
    ...
    MIESC_VERSION = "6.0.0"  # Fallback version
...
class AuditReportGenerator:
    ...
    def _generate_methodology_section(self) -> str:
        ...
        <div class="card">
            ...
            <p>This security audit was conducted using <strong>MIESC v{MIESC_VERSION}</strong>
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by <strong>MIESC v{MIESC_VERSION}</strong> - Multi-layer Intelligent Evaluation for Smart Contracts</p>
