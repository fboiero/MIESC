...
def _show_benchmark_history(benchmark_dir: Path, project_id: str) -> None:
...
def _compare_benchmarks(
    benchmark_dir: Path, project_id: str, compare_to: str, current: dict[str, Any]
) -> None:
...
def _generate_benchmark_report(metrics: dict[str, Any], output_path: str, period: str) -> None:
