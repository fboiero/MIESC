#!/bin/bash
# =============================================================================
# MIESC v6.0.0 - DEMO COMPLETA CORE LOCAL
...
demo_ml() {
    ...
    echo -e "     Reduccion de FP: valor ilustrativo de demo (no medido)"
    echo ""
    echo -e "  ${GREEN}2. SeverityPredictor${NC}"
    echo -e "     Ajusta severidad basado en contexto"
    echo -e "     Precision: valor ilustrativo de demo (no medido)"
    echo ""
...
demo_validacion() {
    ...
    echo -e "${WHITE}Metricas de validacion (benchmarks reproducibles):${NC}"
    echo ""

    echo -e "  ${CYAN}┌────────────────────────────────────────────────┐${NC}"
    echo -e "  ${CYAN}│${NC}  Benchmark reproducible        Recall medido ${CYAN}│${NC}"
    echo -e "  ${CYAN}├────────────────────────────────────────────────┤${NC}"
    echo -e "  ${CYAN}│${NC}  ${GREEN}SmartBugs-curated${NC}           95.8% (137/143) ${CYAN}│${NC}"
    echo -e "  ${CYAN}│${NC}  ${GREEN}EVMBench (ensemble)${NC}         92.5% (111/120) ${CYAN}│${NC}"
    echo -e "  ${CYAN}│${NC}  ${GREEN}Exploits DeFi reales${NC}           81.8% (9/11) ${CYAN}│${NC}"
    echo -e "  ${CYAN}└────────────────────────────────────────────────┘${NC}"
    echo ""

    echo -e "${WHITE}Metodologia:${NC}"
    echo -e "  • Datasets publicos: SmartBugs-curated, EVMBench, exploits DeFi reales"
    echo -e "  • Metrica reportada: recall sobre etiquetas reproducibles"
    echo -e "  • Intervalo de confianza (Wilson) para exploits DeFi: 95% [52%, 95%]"
    echo -e "  • Fuente: benchmarks/results/paper1_claims_matrix.json"
    echo ""
...
demo_resumen() {
    print_section "RESUMEN - MIESC v6.0.0"
    ...
    echo -e "  ${GREEN}3.${NC} Pipeline ML para reduccion de falsos positivos"
    ...
    echo -e "  ${GREEN}6.${NC} Validacion sobre benchmarks reproducibles (SmartBugs-curated, EVMBench, exploits DeFi)"
    echo ""

    echo -e "${WHITE}Impacto:${NC}"
    echo ""
    echo -e "  ${CYAN}•${NC} Recall: 95.8% en SmartBugs-curated (137/143)"
