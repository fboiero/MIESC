...
Described in our companion paper~\cite{boiero2025miesc}. The latest SmartBugs full-corpus reproducible profile reaches 93.7\% recall on 143 contracts, while the EVMBench local high-severity extraction reaches 92.5\% recall using a four-provider union ensemble over 120 local findings. The scanner outputs a normalized JSON with findings, severity, location, confidence, canonical category, and remediation fields consumed by the patcher.
