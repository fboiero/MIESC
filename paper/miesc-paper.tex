...
% TODO: Add Figure 1 — architecture pipeline diagram (Input → 9 Layers → RAG/ML → Report)
MIESC implements a \emph{defense-in-depth} architecture organized into 9 layers, following the principle that multiple independent security mechanisms provide stronger protection than any single mechanism~\cite{saltzer1975protection}. Each layer targets complementary vulnerability classes (Table~\ref{tab:layers}).
