...
\vspace{2pt}
\footnotesize{\textsuperscript{a}Static-only evaluated on 10-audit subset; recall on the full set is structurally identical (pattern matching does not depend on sample size). Ollama 40-audit validation pending (local model, \$0 cost).}
\end{table}
