...
Each pattern includes the vulnerability description, severity, a real-world exploit reference (e.g., Curve \$70M, Euler \$197M, Ronin \$624M), detection heuristics, and fix templates. The system uses $O(1)$ lookup with an LRU cache (256 entries, 5-minute TTL) achieving 90\%+ cache hit rate in batch analysis.
