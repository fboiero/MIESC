...
class AIAgent(BaseAgent):
    ...
    def _build_triage_prompt(self, findings: List[Dict[str, Any]],
        ...
        prompt = f"""
Analyze the following smart contract vulnerability findings and classify them as real vulnerabilities or false positives.
...
3. Is it exploitable in practice?
